...
class LLMClient:
    ...
    async def chat_completion(self, messages : List[dict[str,Any]], stream : bool = True) -> AsyncGenerator[Optional[StreamEvent], None]:

        client = self.get_client()
        kwargs  ={"model":"arcee-ai/trinity-large-preview:free",
                "messages":messages,
                "stream" : stream}
        
        print('model using  :',kwargs['model'])
